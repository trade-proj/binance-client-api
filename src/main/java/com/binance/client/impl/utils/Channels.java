...
public abstract class Channels {
    ...
    public static String continuousCandlestickChannel(String symbol, String contractType, CandlestickInterval interval) {
      JSONObject json = new JSONObject();
      JSONArray params = new JSONArray();
      System.out.println(symbol+"_" + contractType + "@continuousKline_" + interval);
      params.add(symbol+"_" + contractType + "@continuousKline_" + interval);
      json.put("params", params);
      json.put("id", System.currentTimeMillis());
      json.put("method", "SUBSCRIBE");
      return json.toJSONString();
